            ...
            <div className="col-lg-6 px-2 my-4 d-flex justify-content-center flex-column gap-2">
              ...
              <div className="footer-links d-flex flex-wrap gap-4">
                <div className="d-flex flex-column">
                  <h4>Connect</h4>
                  <span>
                    <a href="https://www.houzz.com/professionals/window-treatments/sota-window-coverings-pfvwus-pf~1762534943">
                      <FontAwesomeIcon icon={faHouzz} /> Houzz
                    </a>
                  </span>
                  <span>
                    <a href="https://www.facebook.com/SOTA-Window-Coverings-162212467184332/">
                      <FontAwesomeIcon icon={faFacebook} /> Facebook
                    </a>
                  </span>
                  <span>
                    <a href="https://instagram.com/sota_window_coverings">
                ...
                <div className="d-flex flex-column">
                  ...
                  <span>
                    <a href="mailto: sales@sotadecor.com">
                      <FontAwesomeIcon icon={faEnvelope} /> sales@sotadecor.com
                    </a>
                  </span>
                </div>
              </div>
